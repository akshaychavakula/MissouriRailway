...
<html>
    <head>
        <title>Search Conductor History</title>
    </head>
    <body>
        ...
        <?php
            ...
            if(isset($_POST['submit'])){
                ...
                if($_POST['criteria'] == 0){
                    $sql = "SELECT * FROM `conductor_history` WHERE `trainNumber` LIKE ?";
                    ...
                    $sql = "SELECT * FROM `conductor_history` WHERE `id` LIKE ?";
                    $stmt = $mysqli->stmt_init();
                    if(!$stmt->prepare($sql)){
                        echo "prepare failed";
                        exit();
                ...
                ?>
                <td>
                    <form action="adminUpdateCondHistory.php" method="POST">
